...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Post.image2'
        db.delete_column('dztong_post', 'image2')

        # Adding field 'Post.image'
        db.add_column('dztong_post', 'image', self.gf('django.db.models.fields.files.ImageField')(default=datetime.date(2010, 9, 23), max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Post.image2'
        raise RuntimeError(
            "Cannot reverse this migration. 'Post.image2' and its values cannot be restored.")

        # Deleting field 'Post.image'
        db.delete_column('dztong_post', 'image')
