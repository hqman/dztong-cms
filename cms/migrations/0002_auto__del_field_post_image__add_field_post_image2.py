...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.image2'
        db.add_column('dztong_post', 'image2', self.gf('django.db.models.fields.files.ImageField')(default=datetime.date(2010, 9, 23), max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # We cannot add back in field 'Post.image'
        raise RuntimeError(
            "Cannot reverse this migration. 'Post.image' and its values cannot be restored.")
