...
class BaseCommentNode(template.Node):
    ...
    #@classmethod   # {% get_whatever for obj as varname %}
    """解析字符串  到对应的字段 object_expr==》 as_varname==>上下文变量 """
    def handle_token(cls, parser, token):
        ...
        if len(tokens) == 5:
            ...
            return cls(
            #parser.compile_filter 根据 obj 返回一个 FilterExpression 解析 filter 然后运行
    ...
    #@staticmethod  得到评论对应 model 的类型 如Post
    ...
    def __init__(self, ctype=None, object_pk_expr=None, object_expr=None, as_varname=None, comment=None):
        ...
        self.comment_model =DZComment #comments.get_model()
        self.as_varname = as_varname
        self.ctype = ctype
        self.object_pk_expr = object_pk_expr #外键
...
def get_dzcomment_form(parser, token):

    return DZCommentFormNode()

def DZCommentFormNode(self):
...
return comments.get_form_target()
    ...
    return urlresolvers.reverse("dztong.comment.views.comments.post_comment")
