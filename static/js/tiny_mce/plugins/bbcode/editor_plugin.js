    ...
    tinymce.create("tinymce.plugins.BBCodePlugin", {
        init: function(a, b){
            ...
            a.onPostProcess.add(function(e, f){
                ...
                if (f.get) {
					//alert("get"+_punbb_bbcode2html(f.content))
                    //f.content=_punbb_bbcode2html(f.content); // = d["_" + c + "_html2bbcode"](f.content)
                    //$('id_content').value=_punbb_bbcode2html(f.content);
                }
            })
        },
        getInfo: function(){
